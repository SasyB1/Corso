...
let a1 = 4
let a2 = 12
if (a1 === 8||a2 === 8||a1+a2 === 8||a1-a2 ===8|| a2-a1 === 8) {
...
var totalShoppingCart2 = totalShoppingCart * 0.8
if (totalShoppingCart2 < 50){
  console.log("Totale:", totalShoppingCart2);
} else {
  console.log("Totale:",totalShoppingCart2 + spedizione);
}
/* ESERCIZIO 7
...
}else {console.log("uguale o maggiore di 10");}
